...
setGeneric(".get.history.EMP<-",function(obj,value,replace=FALSE,all=FALSE,experiment,...) standardGeneric(".get.history.EMP<-"))
setMethod(".get.history.EMP<-","EMP",function(obj,value,replace=FALSE,all=FALSE,experiment,...){
  if(replace==FALSE){
    if(all == FALSE){
