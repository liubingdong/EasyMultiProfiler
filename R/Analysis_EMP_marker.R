...
.EMP_Boruta_analysis_m <- memoise::memoise(.EMP_Boruta_analysis,cache = cachem::cache_mem(max_size = 4096 * 1024^2))
...
.EMP_rf_analysis_m <- memoise::memoise(.EMP_rf_analysis,cache = cachem::cache_mem(max_size = 4096 * 1024^2))
...
.EMP_xgb_analysis_m <- memoise::memoise(.EMP_xgb_analysis,cache = cachem::cache_mem(max_size = 4096 * 1024^2))
...
.EMP_lasso_analysis_m <- memoise::memoise(.EMP_lasso_analysis,cache = cachem::cache_mem(max_size = 4096 * 1024^2))
